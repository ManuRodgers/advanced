...
type CustomerType = (customer: ICustomer) => string; // 函数类型
type InferType<T> = T extends (params: infer P) => any ? P : T; // infer 的类型
type InferTypeResult = InferType<CustomerType>;
